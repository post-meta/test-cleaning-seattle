...
export default function HomePage() {
  ...
  const hero = {
  "heading": "Seattle's Most Trusted Professional Cleaning Service Since Day One",
  "subheading": "Transform your home or office with our reliable, eco-friendly cleaning solutions tailored for Seattle residents.",
  ...
  const features = [
  {
    ...
    "description": "Thorough sanitization and cleaning of all surfaces using eco-friendly products and professional-grade equipment for spotless results."
  }
];
  const services = [
  {
    "title": "Residential Deep Cleaning",
    "description": "Comprehensive home cleaning service including bathrooms, kitchens, bedrooms, and living areas with eco-friendly products and attention to detail.",
