...
export default function ContactPage() {
  ...
  "description": "Ready for professional cleaning services in Seattle? Contact Test Cleaning Seattle for reliable, affordable solutions that keep your space spotless."
};
