...
export default function AboutPage() {
  const business = "Test Cleaning Seattle";
  const location = "Seattle, WA";
  const phone = "";
  
  const aboutContent = {
    heading: "Professional Cleaning Services Since Day One",
    story: ["Test Cleaning Seattle has been serving the Greater Seattle area with reliable, thorough cleaning services. We understand that every home and office deserves exceptional care.","Our experienced team uses eco-friendly products and proven techniques to deliver spotless results. From residential homes to commercial spaces, we exceed expectations every time."],
    mission: "To provide Seattle residents and businesses with superior cleaning services that create healthier, more comfortable environments while delivering exceptional customer satisfaction.",
    values: [{"title":"Excellence","description":"We deliver meticulous attention to detail in every cleaning task, ensuring spotless results that exceed client expectations consistently."}]
  };
